...
final class CurrenciesViewController: UIViewController, CurrenciesStoryboardLodable {
    ...
    private func setupBinding() {
        ...
        //Button that finishes the choice of currencies (if everything is right) and calls the convert screen
        ...
        //Button that clean selected coins
